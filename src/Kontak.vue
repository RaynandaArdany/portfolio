        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <p class="text-body-color mb-9 text-base leading-relaxed">
              Apabila Anda memerlukan informasi dan permintaan, hubungi kami:
            </p>
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">
                  Kp.Cilisung Rt.04 Rw.05 . Indonesia
                </p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">(+62)89 656 288 7790</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div class="w-full">
                <h4 class="text-dark mb-1 text-xl font-bold">Alamat Email</h4>
                <p class="text-body-color text-base">jrian313@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
